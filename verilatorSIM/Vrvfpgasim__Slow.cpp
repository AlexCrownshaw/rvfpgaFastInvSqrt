...
void Vrvfpgasim::_eval_initial(Vrvfpgasim__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->__Vclklast__TOP____VinpClk__TOP__rvfpgasim__swervolf____PVT__fastInvSqrt__DOT__rst_fastInvSqrt 
        = vlTOPp->__VinpClk__TOP__rvfpgasim__swervolf____PVT__fastInvSqrt__DOT__rst_fastInvSqrt;
...
void Vrvfpgasim::_ctor_var_reset() {
    ...
    __VinpClk__TOP__rvfpgasim__swervolf____PVT__fastInvSqrt__DOT__rst_fastInvSqrt = VL_RAND_RESET_I(1);
    ...
    __Vchglast__TOP__rvfpgasim__swervolf__fastInvSqrt__DOT__rst_fastInvSqrt = VL_RAND_RESET_I(1);
