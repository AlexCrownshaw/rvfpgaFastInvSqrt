...
VL_MODULE(Vrvfpgasim) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __VinpClk__TOP__rvfpgasim__swervolf____PVT__fastInvSqrt__DOT__rst_fastInvSqrt;
        ...
        CData/*0:0*/ __Vclklast__TOP____VinpClk__TOP__rvfpgasim__swervolf____PVT__fastInvSqrt__DOT__rst_fastInvSqrt;
        ...
        CData/*0:0*/ __Vchglast__TOP__rvfpgasim__swervolf__fastInvSqrt__DOT__rst_fastInvSqrt;
